...
The pipeline tool to convert .png files to .xnb files within the project is located here: C:\Program Files (x86)\MSBuild\MonoGame\v3.0\Tools\Pipeline.exe
